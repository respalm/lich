    ...
    <main class="wrapper background-backgroundcolor">
        <section class="section">
            ...
            <div class="call-to-action">
                <section class="button-section"> <a class="destination-target_url" id="destination_url" href="http://url-partners.g2afse.com/sl?id=5c9a01798d8a110041454012&pid=23971"> <button type="submit" class="action-button button button-shape button-backgroundcolor"> <span class="button-text button-fontcolor">ДА</span> </button></a>
                </section>
            </div>
        </section>
    </main>
